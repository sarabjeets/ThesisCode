...
private double totalProfit;
	...
	protected HashMap<Integer, ArrayList<Double>> msop1 = new HashMap<Integer, ArrayList<Double>>();
	
	public HashMap<Integer, ArrayList<Double>> getmsop(){
	//	System.out.println("sOP is " + msop);
		return msop;
	}
	public HashMap<Integer, ArrayList<Double>> getmsop1(){
		//	System.out.println("sOP is " + msop);
			return msop1;
	}
	public void addmsop(int userid, double record){
		...
		getmsop().put(userid, getmsop().get(userid)); //add entry
		//System.out.println("sOP is " + getmsop());
	}
	public void addmsop1(int userid, double record){
		int b = getmsop1().get(userid).size();
		getmsop1().get(userid).add(record);
		getmsop1().put(userid, getmsop1().get(userid)); //add entry
		//System.out.println("sOP is " + getmsop());
	}
	public void printmsop(int userid){
		System.out.println("sOP is " + getmsop());
	}
	
	
	protected HashMap<Integer, ArrayList<Double>> maop = new HashMap<>();
	protected HashMap<Integer, ArrayList<Double>> maop1 = new HashMap<>();
	
	
	
	public HashMap<Integer, ArrayList<Double>> getmaop(){
		//System.out.println("AOP is " + maop);
		return maop;
		
	}
	public HashMap<Integer, ArrayList<Double>> getmaop1(){
		//System.out.println("AOP is " + maop);
		return maop1;
	...
	public void addmaop1(int userid, double record){
		//int b = getmaop().get(userid).size();
		getmaop1().get(userid).add(record);
		getmaop1().put(userid, getmaop1().get(userid)); 
	}
	public void printmaop(int userid){
		System.out.println("aOP is " + getmaop());
	}
	
	
	protected HashMap<Integer, Integer> mtimes = new HashMap<Integer, Integer>();
	//adds the no. of time user is returning
	public void addmtimes(int userid){
		int times = getmtimes().get(userid); //mapped userid is being called 
		times++; //times = for how many time user will return
		mtimes.put(userid, times);
	}
	//protected HashMap<Integer, Integer> mtimes1 = new HashMap<Integer, Integer>();
	//adds the no. of time user is returning
	/**public void addmtimes1(int userid){
		int times = getmtimes1().get(userid); //mapped userid is being called 
		times++; //times = for how many time user will return
		mtimes1.put(userid, times);
	}
	*/
	...
	//public HashMap<Integer, Integer> getmtimes1(){
		//return mtimes1;
	//}
